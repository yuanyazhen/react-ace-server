...
var ReactAce = function (_Component) {
  ...
  _createClass(ReactAce, [{
    ...
    value: function componentDidMount() {
      ...
      var assetsPath = this.props.assetsPath;

      var path = {
        ace: assetsPath + '/ace.js',
        options: [assetsPath + '/ext_language_tools.js', assetsPath + '/ext_searchbox.js', assetsPath + '/mode_lua.js', assetsPath + '/theme_tomorrow_night_bright.js']
      };
